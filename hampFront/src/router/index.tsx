...
export const menuRoutes: MenuRouteGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: 'work-orders/create', name: '작업지시 등록', element: <FoodWorkOrderCreatePage />, hidden: true },
      { path: 'work-orders/:workId', name: '작업지시 상세', element: <FoodWorkOrderDetailPage />, hidden: true },
