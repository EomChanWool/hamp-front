...
const DEF = mesScreens.equipmentAlarmSystem
...
export function EquipmentAlarmSystemPage() {
  ...
  return (
    <section className="screenStack">
      ...
      <TablePanel title={`${DEF.title} 목록`} headers={[...DEF.columns, '관리']} rows={tableRows} totalCount={filteredRows.length} action="처리" onAction={() => window.alert('mock 동작입니다.')} onRowClick={(i) => setModalRow(filteredRows[i])} />
