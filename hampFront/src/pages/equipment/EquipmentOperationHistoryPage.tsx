...
const DEF = mesScreens.equipmentOperationHistory
...
export function EquipmentOperationHistoryPage() {
  ...
  return (
    <section className="screenStack">
      ...
      <TablePanel title={`${DEF.title} 목록`} headers={[...DEF.columns, '관리']} rows={tableRows} totalCount={filteredRows.length} action="상세" onAction={() => window.alert('mock 동작입니다.')} onRowClick={(i) => setModalRow(filteredRows[i])} />
