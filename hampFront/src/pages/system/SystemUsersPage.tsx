...
const DEF = mesScreens.systemUsers

export function SystemUsersPage() {
  const { filteredRows, keyword, setKeyword, modalRow, setModalRow, handleDelete, handleSave } =
  ...
  return (
    <section className="screenStack">
      ...
      <TablePanel
        ...
        action="등록"
        onAction={() => window.alert('등록 기능은 API 연동 후 사용 가능합니다.')}
